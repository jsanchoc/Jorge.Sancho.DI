...
public class Tarea {
    ...
    public void agregarEncargo(Encargo encargo){
        if (estaEncargo(encargo.getId()) == null){
            ...
            System.out.println("encargo no posible de agregar");
        }
    }
    ...
    public void mostrarEncargo(int id){
        ...
        if (encargoEncontrado!=null){
            encargoEncontrado.mostrarDatos();
        }
    }

    public void eliminarEncargo(int id){
        for (Encargo encargoEncontrado : encargos){
            if (encargoEncontrado.getId() == id){
    ...
    public void encargoIncompleto(int id){
    ...
    private Encargo estaEncargo(int id){
        for (Encargo encargo: encargos){
            if (encargo.getId() == id){
                ...
                System.out.println("No hay encargo");
            }
        }
        return null;
    }
